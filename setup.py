...
if __name__ == '__main__':
    setup(
        ...
        author='vnprofi (Enhanced by AI)',
        author_email='vnprofi@github.com',
        packages=[PACKAGE_NAME],
        include_package_data=True,
        python_requires='>=3.8',
        keywords='parser scraper 2gis enhanced pagination extended-data',
        url='https://github.com/vnprofi/repo12c',
        project_urls={
            'Documentation': 'https://github.com/vnprofi/repo12c/wiki',
            'GitHub': 'https://github.com/vnprofi/repo12c',
            'Changelog': 'https://github.com/vnprofi/repo12c/blob/main/CHANGELOG.md',
            'Original': 'https://github.com/interlark/parser-2gis',
        },
        install_requires=[
            'pychrome==0.2.4',
            'pydantic>=1.9.0,<2.0',
