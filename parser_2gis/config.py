...
class Configuration(BaseModel):
    ...
    def merge_with(self, other_config: Configuration) -> None:
        ...
        def assign_attributes(model_source: BaseModel,
            ...
            # Try different ways to get fields depending on Pydantic version
            try:
                # Pydantic v2 approach
                fields_set = model_source.model_fields_set if hasattr(model_source, 'model_fields_set') else set()
                ...
                try:
                    ...
                    fields_set = set(model_source.__dict__.keys())
            ...
            for field in fields_set:
                if hasattr(model_source, field):
                    ...
                    if not isinstance(source_attr, BaseModel):
                        ...
                        if isinstance(target_attr, BaseModel):
