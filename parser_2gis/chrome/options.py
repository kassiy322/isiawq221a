...
class ChromeOptions(BaseModel):
    ...
    Attributes:
        ...
        start_maximized: Start browser maximized (default True for better visibility).
        headless: Start browser hidden, without GUI (default False for debugging).
    ...
    start_maximized: bool = True  # Changed to True for better visibility
    headless: bool = False  # Changed to False for always visible browser
